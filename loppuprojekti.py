...
n = len(df["Time (s)"]) #Datanäytteiden lukumäärä
...
#Havertsinen kaava pisteiden välimatkojen laskemiseen
...
step_count = 779  # Suodatettujen askelten määrä
